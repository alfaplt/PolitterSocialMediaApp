...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240206120341_columnAddedForPostsTable")]
    partial class columnAddedForPostsTable
    {
            ...
            modelBuilder.Entity("Core.Entities.Post", b =>
                {
                    ...
                    b.Property<string>("OriginalPostOwner")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entities.Follow", b =>
                {
                    ...
                    b.HasOne("Core.Entities.AppUser", "Following")
                        .WithMany("Followings")
